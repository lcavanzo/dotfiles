...
BREW_PACKAGES	:= \
	argocd atuin awscli azure-cli ast-grep bat bruno btop carapace cleanshot fish fd fzf git git-delta git-credential-manager go imagemagick helm ghostty btop jq karabiner-elements knqyf263/pet/pet kubectl Azure/kubelogin/kubelogin lazygit \
	kubectx fastfetch openfga/tap/fga obsidian neovim node nmap pkgconfig pngpaste poppler rar rectangle-pro ripgrep starship sesh stow  tree tmux unzip vlc watch wget wezterm trash yazi yq xclip zoxide zsh
