...
BREW_PACKAGES	:= \
	atuin awscli azure-cli bat bruno btop cleanshot fish fd fzf git git-delta go imagemagick helm btop jq karabiner-elements knqyf263/pet/pet kubectl Azure/kubelogin/kubelogin lazygit \
