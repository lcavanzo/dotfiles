...
BREW_PACKAGES	:= \
	atuin awscli azure-cli ast-grep bat bruno btop carapace cleanshot fish fd fzf git git-delta git-credential-manager go imagemagick helm ghostty btop jq karabiner-elements knqyf263/pet/pet kubectl Azure/kubelogin/kubelogin lazygit \
