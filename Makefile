...
BREW_PACKAGES	:= \
	atuin awscli azure-cli bat bruno btop cleanshot fish fd fzf git git-delta go imagemagick helm ghostty btop jq karabiner-elements knqyf263/pet/pet kubectl Azure/kubelogin/kubelogin lazygit \
	fastfetch obsidian neovim node nmap pkgconfig pngpaste poppler rar rectangle-pro ripgrep starship sesh stow terraform tree tmux unzip vlc watch wget wezterm trash yazi yq xclip zoxide zsh
